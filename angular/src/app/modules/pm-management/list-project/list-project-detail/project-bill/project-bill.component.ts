...
import { AddAccountAssetDialogComponent } from './add-account-asset-dialog/add-account-asset-dialog.component';
...
export class ProjectBillComponent extends AppComponentBase implements OnInit {
  ...
  isShowOTType(){
    return this.isGranted(PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabBillInfo_OTType_View)
  }
