...
export class WeeklyReportComponent extends PagedListingComponentBase<WeeklyReportComponent> implements OnInit {
  ...
  Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_ChangeOverAllProjectHealthCriteria = PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_ChangeOverAllProjectHealthCriteria
      ...
      this.pmReportProjectService.GetCurrentResourceOfProject(this.projectId)
        .pipe(catchError(this.pmReportProjectService.handleError)).subscribe(data => {
          ...
          this.projectCurrentResource.forEach(user => {
            ...
            this.GetTimesheetOfUserInProjectNew(projectCode, user, this.getCurrentLastWeekMonday(), this.lastWeekSunday)
          })
          this.getUserFromTimesheet(projectCode, usersEmail, this.getCurrentLastWeekMonday())
