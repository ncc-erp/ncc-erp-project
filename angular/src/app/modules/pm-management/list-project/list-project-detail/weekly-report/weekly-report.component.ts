...
import {
  ...
  WorkingTimeDto,
} from "./../../../../delivery-management/delivery/weekly-report-tab/weekly-report-tab-detail/get-timesheet-working/get-timesheet-working.component";
import { ListProjectService } from "@app/service/api/list-project.service";
import { PERMISSIONS_CONSTANT } from "./../../../../../constant/permission.constant";
import {
  ReportRiskDto,
  pmReportDto,
} from "./../../../../../service/model/pmReport.dto";
...
import {
  projectReportDto,
  projectProblemDto,
} from "./../../../../../service/model/projectReport.dto";
...
} from "../resource-management/confirm-popup/confirm-popup.component";
...
export class WeeklyReportComponent
  ...
  public projectType = "";
  public statusProject: number = 0;
  public statusProjectHistory: number = 0;
  ...
  public riskStatusList: string[] = Object.keys(
  ...
  public defaultStatus =
    this.APP_ENUM.PMReportProjectIssueStatus[this.issueStatusList[0]];
  Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_View =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_View;
  Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_ChangeOverAllProjectHealthCriteria =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_ChangeOverAllProjectHealthCriteria;
  Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_UpdateNote =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_UpdateNote;
  Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_UpdateProjectHealth =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_UpdateProjectHealth;
  Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_SendWeeklyReport =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_SendWeeklyReport;

  Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_ProjectIssue =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_PMProjectIssue;
  Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_ProjectIssue_View =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_PMProjectIssue_View;
  Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_ProjectIssue_AddNewIssue =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_PMProjectIssue_AddNewIssue;
  Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_ProjectIssue_Edit =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_PMProjectIssue_Edit;
  Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_ProjectIssue_Delete =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_PMProjectIssue_Delete;
  Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_ProjectIssue_SetDone =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_PMProjectIssue_SetDone;
  Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_ProjectIssue_ConvertToRisk =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_PMProjectIssue_ConvertToRisk;

  Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_PMProjectRisk =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_PMProjectRisk;
  Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_PMProjectRisk_View =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_PMProjectRisk_View;
  Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_PMProjectRisk_AddNewRisk =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_PMProjectRisk_AddNewRisk;
  Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_PMProjectRisk_Edit =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_PMProjectRisk_Edit;
  Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_PMProjectRisk_Delete =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_PMProjectRisk_Delete;
  Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_PMProjectRisk_SetDone =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_PMProjectRisk_SetDone;
  Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_PMProjectRisk_ConvertToIssue =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_PMProjectRisk_ConvertToIssue;

  Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_CurrentResource =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_CurrentResource;
  Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_CurrentResource_View =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_CurrentResource_View;
  Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_CurrentResource_Release =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_CurrentResource_Release;
  Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_CurrentResource_Update_Note =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_CurrentResource_Update_Note;

  Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_BillAccount =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_BillAccount;
  Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_BillAccount_View =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_BillAccount_View;

  Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_PlannedResource =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_PlannedResource;
  Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_PlannedResource_View =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_PlannedResource_View;
  Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_PlannedResource_CreateNewPlan =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_PlannedResource_CreateNewPlan;
  Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_PlannedResource_Edit =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_PlannedResource_Edit;
  Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_PlannedResource_ConfirmPickEmployeeFromPoolToProject =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_PlannedResource_ConfirmPickEmployeeFromPoolToProject;
  ...
  Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_PlannedResource_ConfirmOut =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_PlannedResource_ConfirmOut;
  Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_PlannedResource_CancelPlan =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_PlannedResource_CancelPlan;

  Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_ChangedResource =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_ChangedResource;
  Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_ChangedResource_View =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_ChangedResource_View;

  ProjectHealthCriteria_View =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_ProjectHealthCriteria_View;
  ProjectHealthCriteria_ChangeStatus =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_ProjectHealthCriteria_ChangeStatus;
  ProjectHealthCriteria_Edit =
    PERMISSIONS_CONSTANT.Projects_OutsourcingProjects_ProjectDetail_TabWeeklyReport_ProjectHealthCriteria_Edit;

  WeeklyReport_ReportDetail_ProjectHealthCriteria_View_Guideline =
    PERMISSIONS_CONSTANT.WeeklyReport_ReportDetail_ProjectHealthCriteria_View_Guideline;

  WeeklyReport_ReportDetail_GuideLine_View =
    PERMISSIONS_CONSTANT.WeeklyReport_ReportDetail_GuideLine_View;
  ...
  ngOnInit(): void {
    ...
    this.mondayOf5weeksAgo = new Date(
      currentDate.getFullYear(),
      currentDate.getMonth(),
      currentDate.getDate(),
    );
    this.mondayOf5weeksAgo = moment(
      this.mondayOf5weeksAgo.setDate(this.mondayOf5weeksAgo.getDate() - 28),
    ).format("YYYY-MM-DD");
    this.lastWeekSunday = moment(
      new Date(
        currentDate.getFullYear(),
        currentDate.getMonth(),
  ...
  public getAllPmReport() {
    this.pmReportProjectService
      .GetAllByProject(this.projectId)
      .pipe(catchError(this.pmReportProjectService.handleError))
      .subscribe((data) => {
        this.pmReportList = data.result;
        this.selectedReport = this.pmReportList.filter(
          (item) => item.isActive == true,
        )[0];
        this.isSentReport =
          this.selectedReport.status == "Draft" ? true : false;
        this.allowSendReport =
          this.selectedReport.note == null || this.selectedReport.note == ""
            ? false
            : true;
        this.projectHealth =
  ...
  public getAllCriteria() {
    forkJoin([
      this.pjCriteriaService.getAll(),
      this.pjCriteriaResultService.getAllCriteriaResult(
        this.projectId,
      ...
      const listTmpCriteriaResult =
        resCriteriaResult.result as ProjectCriteriaResultDto[];
      for (let i = 0; i < listTmpCriteria.length; i++) {
        const criteria = listTmpCriteria[i];
        const check = listTmpCriteriaResult.find(
          (item) => item.projectCriteriaId === listTmpCriteria[i].id,
        );
    ...
    this.pjCriteriaResultService
      ...
      .subscribe(
        (data) => {
          ...
          const criteriaWithValues = this.listCriteriaResult
            .filter((item) => item.note && item.note.trim() !== "")
            .map((item) => {
              return { ...item, status: this.statusProject };
            });

          if (criteriaWithValues.length > 0) {
            this.pjCriteriaResultService
              .updateAllCriteriaResult(criteriaWithValues)
              .subscribe(() => {
                abp.notify.success("Update evaluation criteria successful");
                this.getAllCriteria();
              });
          } else {
            this.getAllCriteria();
  ...
  setTotalHealth() {
    this.statusProject = 0;
    this.statusProjectHistory = 0;
    for (let i = 0; i < this.listCriteriaResult.length; i++) {
      let tmpPriority = 1;
      if (
        !this.listCriteriaResult[i].status &&
        this.selectedReport.status == "Draft"
      ) {
        tmpPriority = 100;
      } else if (
        this.listCriteriaResult[i].status === APP_ENUMS.ProjectHealth.Red
      ) {
        tmpPriority = 3;
      } else if (
        this.listCriteriaResult[i].status === APP_ENUMS.ProjectHealth.Yellow
      ) {
        tmpPriority = 2;
      }

      if (tmpPriority > this.statusProject) {
        this.statusProject = tmpPriority;
        this.statusProjectHistory = this.statusProject;
      }
    }
    const empty = this.listCriteriaResult.filter(
      (x) => x.note == "" || !x.status || x.editMode,
    );
    empty.length > 0
      ? (this.isValidCriteria = false)
      : (this.isValidCriteria = true);
    this.handleBGStatus(this.statusProject);
  }
  ...
  public cancelEditCriteriaResult(index: number) {
    this.listCriteriaResult[index].note =
      this.listPreEditCriteriaResult[index].note;
    this.listCriteriaResult[index].status =
      this.listPreEditCriteriaResult[index].status;
  ...
  public getChangedResource() {
    if (this.projectId) {
      this.pmReportProjectService
        .getChangesDuringWeek(this.projectId, this.selectedReport.reportId)
        .pipe(catchError(this.pmReportProjectService.handleError))
        .subscribe((data) => {
          this.weeklyReportList = data.result;
          this.isShowWeeklyList =
            this.weeklyReportList.length == 0 ? false : true;
        });
    }
  }
  public getFuturereport() {
    if (this.projectId) {
      this.pmReportProjectService
        .getChangesInFuture(this.projectId, this.selectedReport.reportId)
        .pipe(catchError(this.pmReportProjectService.handleError))
        .subscribe((data) => {
          this.futureReportList = data.result;
          this.isShowFutureList =
            this.futureReportList.length == 0 ? false : true;
        });
    }
  }
  public getProjectProblem() {
    if (this.projectId) {
      this.pmReportProjectService
        .problemsOfTheWeekForReport(
          this.projectId,
          this.selectedReport.reportId,
        )
        .pipe(catchError(this.reportIssueService.handleError))
        .subscribe((data) => {
          if (data.result) {
            this.problemList = [];
  ...
  setDoneRisk(risk) {
    ...
    this.pmReportRiskService
      .UpdateReportRisk(Risk)
      .pipe(catchError(this.pmReportRiskService.handleError))
      .subscribe((res) => {
        if (res) {
  ...
  changePriority(e, risk) {
    this.pmReportRiskService
      .UpdateReportRisk({ ...risk, priority: e.value })
      .pipe(catchError(this.pmReportRiskService.handleError))
      .subscribe((res) => {
        if (res) {
          abp.notify.success("Update Successfully!");
  ...
  public getRiskOfTheWeek() {
    if (
      ...
      this.pmReportRiskService
        .getRiskOfTheWeek(this.projectId, this.selectedReport.reportId)
        .pipe(catchError(this.pmReportRiskService.handleError))
        .subscribe((data) => {
          if (data.result) {
  ...
  public deleteRisk(risk) {
    abp.message.confirm("Delete Risk? ", "", (result: boolean) => {
      if (result) {
        this.pmReportRiskService
          .deleteReportRisk(risk.id)
          .pipe(catchError(this.pmReportRiskService.handleError))
          .subscribe(() => {
  ...
  deleteWeekReport(report) {
    abp.message.confirm("Delete Issue? ", "", (result: boolean) => {
      if (result) {
        this.projectUserService
          .removeProjectUser(report.id)
          .pipe(catchError(this.projectUserService.handleError))
          .subscribe(() => {
  ...
  public saveProblemReport(problem: projectProblemDto) {
    ...
    if (!this.isEditProblem) {
      this.reportIssueService
        .createReportIssue(this.projectId, problem)
        .pipe(catchError(this.reportIssueService.handleError))
        .subscribe(
          (data) => {
  ...
  public updateNote() {
    this.reportService
      .updateNote(
        this.projectInfo.pmNote,
        this.selectedReport.pmReportProjectId,
      )
      .pipe(catchError(this.reportService.handleError))
      .subscribe((rs) => {
  ...
  public updateAutoNote() {
    this.pmReportProjectService
      .updateAutomationNote(
        this.projectInfo.automationNote,
        this.selectedReport.pmReportProjectId,
      )
      .pipe(catchError(this.pmReportProjectService.handleError))
      .subscribe((rs) => {
  ...
  convertToRisk(issue) {
    abp.message.confirm("Convert Issue to Risk ?", "", (result: boolean) => {
      if (result) {
        this.reportIssueService
          .convertToRisk(issue.id)
          .pipe(catchError(this.reportIssueService.handleError))
          .subscribe((res) => {
            if (res.success) {
  ...
  convertToIssue(risk) {
    abp.message.confirm("Convert Risk to Issue?", "", (result: boolean) => {
      if (result) {
        this.pmReportRiskService
          .convertToIssue(risk.id)
          .pipe(catchError(this.pmReportRiskService.handleError))
          .subscribe((res) => {
            if (res.success) {
              abp.notify.success("Convert successful");
  ...
  getCurrentResourceOfProject(projectCode) {
    if (this.projectId) {
      ...
      let usersEmail = [];
      this.pmReportProjectService
        .GetCurrentResourceOfProject(this.projectId)
        .pipe(catchError(this.pmReportProjectService.handleError))
        .subscribe((data) => {
          ...
          this.projectCurrentResource.forEach((user) => {
            ...
            this.GetTimesheetWeeklyChartOfUserInProject(
              projectCode,
              user,
              this.mondayOf5weeksAgo,
              this.lastWeekSunday,
            );
            this.GetTimesheetOfUserInProjectNew(
              projectCode,
              user,
              this.getCurrentLastWeekMonday(),
              this.lastWeekSunday,
            );
          });
          this.getUserFromTimesheet(
            projectCode,
            usersEmail,
            this.getCurrentLastWeekMonday(),
          );
  ...
  getViewSubject() {
    forkJoin([
      ...
      .pipe(
        map((responses) => {
          const data1 = responses[0].result;
          const data2 = responses[1].result;
    ...
    this.pmReportProjectService
      ...
      .subscribe((rs) => {
        ...
        this.projectCurrentSupportUser.forEach((user) => {
          this.GetTimesheetOfSupportUserInProject(
            projectCode,
            user,
            lastWeekMonday,
            this.lastWeekSunday,
  ...
  buildProjectTSChart(normalAndOTchartData, officalChartData, TempChartData) {
    setTimeout(() => {
      ...
      let hasOtValue = normalAndOTchartData?.overTimeHours.some(
        (item) => item > 0,
      );
      let hasOfficalDataNormal = officalChartData?.normalWoringHours.some(
        (item) => item > 0,
      );
      let hasOfficalDataOT = officalChartData?.overTimeHours.some(
        (item) => item > 0,
      );
      let hasTempDataNormal = TempChartData?.normalWoringHours.some(
        (item) => item > 0,
      );
      let hasTempDataOT = TempChartData?.overTimeHours.some((item) => item > 0);
      let hasOtNoCharge = normalAndOTchartData?.otNoChargeHours.some(
        (item) => item > 0,
      );

      if (
        JSON.stringify(normalAndOTchartData?.normalWoringHours) ==
        JSON.stringify(officalChartData?.normalWoringHours)
      ) {
        hasOfficalDataNormal = false;
      }
      if (
        JSON.stringify(normalAndOTchartData?.overTimeHours) ==
        JSON.stringify(officalChartData?.overTimeHours)
      ) {
      ...
      option = {
        ...
        legend: {
          ...
          data: [
            "Total normal",
            `${hasOtValue ? "Total OT" : ""}`,
            `${hasOfficalDataNormal ? "Normal Offical" : ""}`,
            `${hasOfficalDataOT ? "OT Offical" : ""}`,
            `${hasTempDataNormal ? "Normal Temp" : ""}`,
            `${hasTempDataOT ? "OT Temp" : ""}`,
            `${hasOtNoCharge ? "OT NoCharge" : ""}`,
          ],
        },
        color: [
          "#211f1f",
        ...
        series: [
          ...
          },
          {
            ...
            name: "Normal Offical",
            type: "line",
            data: hasOfficalDataNormal
              ? officalChartData?.normalWoringHours
              : [],
          },
          {
  ...
  getDataForWeeklyChart(projectCode, startTime, endTime) {
    let totalNormalAndOT =
      this.pmReportProjectService.GetTimesheetWeeklyChartOfProject(
        projectCode,
        startTime,
        endTime,
      );
    ...
    if (this.officalResourceList.length > 0) {
      ...
      offical =
        this.pmReportProjectService.GetTimesheetWeeklyChartOfUserGroupInProject(
          apiPayload,
        );
  ...
  getDataForBillChart(projectCode: string) {
    ...
    fiveMonthAgo = this.formatDateYMD(
      this.getFirstDayOfMonth(
        fiveMonthAgo.getFullYear(),
        fiveMonthAgo.getMonth(),
      ),
    );
    ...
    let effort =
      this.pmReportProjectService.GetEffortMonthlyChartProject(apiPayload);
    let bill = this.tsProjectService.GetBillInfoChart(
      this.projectId,
      fiveMonthAgo,
      currentDate,
    );
  ...
  GetTimesheetWeeklyChartOfUserInProject(
    projectCode,
    user,
    startTime,
    endTime,
  ...
  GetTimesheetOfUserInProjectNew(projectCode, user, startTime, endTime) {
    this.pmReportProjectService
      .GetTimesheetOfUserInProjectNew(
        projectCode,
        user.emailAddress,
        startTime,
        endTime,
      ...
      .subscribe((rs) => {
        ...
        user.overTime = rs.result ? rs.result.overTime : 0;
        user.overTimeNoCharge = rs.result ? rs.result.overTimeNoCharge : 0;
        user.normalWorkingTimeAll = rs.result
          ? rs.result.normalWorkingTimeAll
          : 0;
        user.normalWorkingTimeStandard = rs.result
          ? rs.result.normalWorkingTimeStandard
          : 0;
        this.totalNormalWorkingTime += user.normalWorkingTime;
        this.totalOverTime += user.overTime;
        this.overTimeNoCharge += user.overTimeNoCharge;
  ...
  updateHealth(projectHealth) {
    this.pmReportProjectService
      .updateHealth(this.selectedReport.pmReportProjectId, projectHealth)
      .subscribe((data) => {
        abp.notify.success(
  ...
  isShowChangeDoneText(issue) {
    return (
      this.APP_ENUM.PMReportProjectIssueStatus[issue.status] ==
      this.APP_ENUM.PMReportProjectIssueStatus.InProgress
    );
  }
  isShowChangeInProgressText(issue) {
    return (
      this.APP_ENUM.PMReportProjectIssueStatus[issue.status] ==
      this.APP_ENUM.PMReportProjectIssueStatus.Done
    );
  }
      ...
      option = {
        ...
        legend: {
          data: [
            "Bill.ManMonth",
            "Bill.ManDay",
            `${EffortData?.manDays ? "Effort.ManDay" : ""}`,
          ],
        },
        xAxis: [
          {
  ...
  public isEditingAllRow() {
    return (
      this.listCriteriaResult.find((s) => !s.editMode) == undefined &&
  ...
  public isShowEditBtnOnRow() {
    return (
      this.isGranted(this.ProjectHealthCriteria_ChangeStatus) ||
  ...
  saveAllUpdate() {
    this.pjCriteriaResultService
      .updateAllCriteriaResult(this.listCriteriaResult)
      .subscribe((res) => {
        if (res.success) {
          abp.notify.success(`Update successfully`);
          this.getAllCriteria();
