...
@Component({
  selector: 'app-training-milestone',
  templateUrl: './training-milestone.component.html',
  styleUrls: ['./training-milestone.component.css']
})
export class TrainingMilestoneComponent extends PagedListingComponentBase<MilestoneDto> implements OnInit {
