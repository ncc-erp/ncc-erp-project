...
@Component({
  selector: 'app-training-project-asset',
  templateUrl: './training-project-asset.component.html',
  styleUrls: ['./training-project-asset.component.css']
})
export class TrainingProjectAssetComponent extends PagedListingComponentBase<TrainingProjectAssetComponent> implements OnInit {
  Projects_TrainingProjects_ProjectDetail_TabProjectAsset_View = PERMISSIONS_CONSTANT.Projects_TrainingProjects_ProjectDetail_TabProjectAsset_View;
  Projects_TrainingProjects_ProjectDetail_TabProjectAsset_Create = PERMISSIONS_CONSTANT.Projects_TrainingProjects_ProjectDetail_TabProjectAsset_Create;
  Projects_TrainingProjects_ProjectDetail_TabProjectAsset_Edit = PERMISSIONS_CONSTANT.Projects_TrainingProjects_ProjectDetail_TabProjectAsset_Edit;
  Projects_TrainingProjects_ProjectDetail_TabProjectAsset_Delete = PERMISSIONS_CONSTANT.Projects_TrainingProjects_ProjectDetail_TabProjectAsset_Delete;
