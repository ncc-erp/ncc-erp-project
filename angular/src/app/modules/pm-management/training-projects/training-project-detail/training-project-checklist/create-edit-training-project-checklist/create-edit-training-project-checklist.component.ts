...
@Component({
  selector: 'app-create-edit-training-project-checklist',
  templateUrl: './create-edit-training-project-checklist.component.html',
  styleUrls: ['./create-edit-training-project-checklist.component.css']
})
export class CreateEditTrainingProjectChecklistComponent extends AppComponentBase implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public data: any, injector: Injector,
    ...
    public dialogRef: MatDialogRef<CreateEditTrainingProjectChecklistComponent>,
