...
@Component({
  selector: 'app-training-project-file',
  templateUrl: './training-project-file.component.html',
  styleUrls: ['./training-project-file.component.css']
})
export class TrainingProjectFileComponent extends AppComponentBase implements OnInit {

  private projectId: number
  public fileList: any[] = []
  public isLoading: boolean = false

  Projects_TrainingProjects_ProjectDetail_TabProjectFile_View = PERMISSIONS_CONSTANT.Projects_TrainingProjects_ProjectDetail_TabProjectFile_View
  Projects_TrainingProjects_ProjectDetail_TabProjectFile_UploadFile = PERMISSIONS_CONSTANT.Projects_TrainingProjects_ProjectDetail_TabProjectFile_UploadFile
  Projects_TrainingProjects_ProjectDetail_TabProjectFile_DeleteFile = PERMISSIONS_CONSTANT.Projects_TrainingProjects_ProjectDetail_TabProjectFile_DeleteFile
