...
@Component({
  ...
  templateUrl: './training-weekly-report.component.html',
  styleUrls: ['./training-weekly-report.component.css']
})
export class TrainingWeeklyReportComponent extends AppComponentBase implements OnInit {
  ...
  Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_ChangeOverAllProjectHealthCriteria = PERMISSIONS_CONSTANT.Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_ChangeOverAllProjectHealthCriteria;
  ...
  Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_SendWeeklyReport = PERMISSIONS_CONSTANT.Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_SendWeeklyReport;

  Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_ProjectIssue = PERMISSIONS_CONSTANT.Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_PMProjectIssue;
  Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_ProjectIssue_View = PERMISSIONS_CONSTANT.Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_PMProjectIssue_View;
  Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_ProjectIssue_AddNewIssue = PERMISSIONS_CONSTANT.Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_PMProjectIssue_AddNewIssue;
  Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_ProjectIssue_Edit = PERMISSIONS_CONSTANT.Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_PMProjectIssue_Edit;
  Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_ProjectIssue_Delete = PERMISSIONS_CONSTANT.Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_PMProjectIssue_Delete;
  Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_ProjectIssue_SetDone = PERMISSIONS_CONSTANT.Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_PMProjectIssue_SetDone;

  Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_CurrentResource = PERMISSIONS_CONSTANT.Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_CurrentResource;
  Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_CurrentResource_View = PERMISSIONS_CONSTANT.Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_CurrentResource_View;
  Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_CurrentResource_Release = PERMISSIONS_CONSTANT.Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_CurrentResource_Release;

  Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_PlannedResource = PERMISSIONS_CONSTANT.Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_PlannedResource;
  Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_PlannedResource_View = PERMISSIONS_CONSTANT.Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_PlannedResource_View;
  Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_PlannedResource_CreateNewPlan = PERMISSIONS_CONSTANT.Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_PlannedResource_CreateNewPlan;
  Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_PlannedResource_Edit = PERMISSIONS_CONSTANT.Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_PlannedResource_Edit;
  Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_PlannedResource_ConfirmPickEmployeeFromPoolToProject = PERMISSIONS_CONSTANT.Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_PlannedResource_ConfirmPickEmployeeFromPoolToProject;
  Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_PlannedResource_ConfirmMoveEmployeeWorkingOnAProjectToOther = PERMISSIONS_CONSTANT.Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_PlannedResource_ConfirmMoveEmployeeWorkingOnAProjectToOther;
  Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_PlannedResource_ConfirmOut = PERMISSIONS_CONSTANT.Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_PlannedResource_ConfirmOut;
  Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_PlannedResource_CancelPlan = PERMISSIONS_CONSTANT.Projects_TrainingProjects_ProjectDetail_TabWeeklyReport_PlannedResource_CancelPlan;
  ...
  onChangeStatusProject(){
    this.pjCriteriaResultService.updateStatus(this.statusProject,this.selectedReport.reportId,this.projectId).pipe(catchError(this.pjCriteriaResultService.handleError)).subscribe(data => {
      ...
      this.projectUserService.GetAllWorkingProjectByUserId(user.userId).subscribe(data => {
        ...
        let ref = this.dialog.open(ConfirmPopupComponent, {
          ...
          data: {
            ...
            user: user,
            type: "confirmJoin",
            page: ConfirmFromPage.training_weekly
          }
        })
