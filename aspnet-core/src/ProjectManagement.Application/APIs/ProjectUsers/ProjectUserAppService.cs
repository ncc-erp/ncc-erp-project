...
namespace ProjectManagement.APIs.ProjectUsers
{
    ...
    public class ProjectUserAppService : ProjectManagementAppServiceBase, IProjectUserAppService
    {
        ...
        [HttpGet]
        [AbpAuthorize()]
        public async Task<List<SubProjectUserDto>> GetCurrentResourceSubProject(long projectId, bool viewHistory)
        {
            var query = _resourceManager.GetCurrentResourceSubProject(projectId, viewHistory);
            return await query.ToListAsync();
        }
